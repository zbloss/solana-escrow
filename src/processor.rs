...
impl Processor {
    ...
    fn process_exchange(
        ...
        msg!("Starting the transfer of tokens to the escrow's initializer...");
        invoke(
        ...
        msg!("callined the program to transfer tokens to the taker");
        invoke_signed(
        ...
        msg!("Closing the pda temp account...");
        invoke_signed(
